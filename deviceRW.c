...
"16F505","16F506","16F526","16F527","16F54","16F57","16F59",
...
"16F1503","16F1507","16F1508","16F1509","16F1516","16F1517","16F1518","16F1519","16F1526","16F1527",
...
"ATmega328","ATmega64","ATmega644A","ATmega1284",
"ATtiny12","ATtiny13",
...
"25X05","25X10","25X20","25X40","25X80","25X16","25X32","25X64",
...
//-------------PIC10-16---------------------------------------------------------
	...
	{"16LF1902,16F1503,16F1507,16F1782",
	...
	{"16LF1903,16LF1904,16F1508,16F1783,16F1784",
	...
	{"16LF1906,16LF1907,16F1509,16F1786,16F1787,16F1454,16F1455,16F1459",
...
//     2 = 550ms erase delay, 3.4ms code write time, no config or EEPROM
	...
	{"18F26K20,18F46K20,18F26K22,18F46K22",
...
//	   3 = config write is 0x4008
	...
	{"24FJ64GA102,24FJ64GA104,24FJ64GB002,24FJ64GB004,24FJ64GA306,24FJ64GA308,24FJ64GA310,24FJ64GC006,24FJ64GC008,24FJ64GC010",
...
//-------------ATMEL---------------------------------------------------------
	...
	{"ATtiny24,ATtiny25",
		AVR,-1,0,ReadAT_HV,{0x800,0x80,LOCK+FUSE+FUSE_H+FUSE_X+CAL},0,WriteAT_HV,{0x800,0x80,16,0},0},	//2K, 128, HV
	{"ATtiny26",
			...
			if(!strcmp(dev,tok)){		//proceed if found
				...
				switch(DEVLIST[i].family){		//call write function with the right number of arguments (better ways to do it???)
					...
					case AVR:
						if(!ee) params[1]=0;					//clear eeprom parameter
						if(params[2]==-10) (*DEVLIST[i].WritePtr)(params[0],params[1]);
						else (*DEVLIST[i].WritePtr)(params[0],params[1],params[2],params[3]);
					break;
					case I2CEE:
